...
import { ImagesContainer } from '../Main/ImagesContainer';

interface Iprops {
    setLightBox: (val: boolean) => void;
    data: IData;
}
export function LightBoxImage ({setLightBox, data}: Iprops) {

    return(
        <div className="light-box">
            <div className="light-box-content">
                <button className="close-light-box" onClick={() => setLightBox(false)}>
